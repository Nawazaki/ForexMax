...
// Dummy Data for a premium look while database integration is finalized
const DUMMY_BROKERS = [
  {
    id: "1",
    name: "IC Markets",
    logoUrl: "https://images.unsplash.com/photo-1611974717461-677ed4757448?q=80&w=500&auto=format&fit=crop",
    websiteUrl: "https://icmarkets.com",
    affiliateLink: "#",
    rating: "4.9/5",
    description: "Industry-leading spreads and lightning-fast execution. The gold standard for professional scalpers.",
  },
  {
    id: "2",
    name: "Pepperstone",
    logoUrl: "https://images.unsplash.com/photo-1633412802377-29c762a96870?q=80&w=500&auto=format&fit=crop",
    websiteUrl: "https://pepperstone.com",
    affiliateLink: "#",
    rating: "4.8/5",
    description: "Superior transparency and world-class support. Perfect for traders moving into high-volume prop firms.",
  },
  {
    id: "3",
    name: "FP Markets",
    logoUrl: "https://images.unsplash.com/photo-1611974717461-677ed4757448?q=80&w=500&auto=format&fit=crop",
    websiteUrl: "https://fpmarkets.com",
    affiliateLink: "#",
    rating: "4.7/5",
    description: "Highly competitive conditions and a robust platform suited for both SMC and classic technical traders.",
  },
  {
    id: "4",
    name: "Exness",
    logoUrl: "https://images.unsplash.com/photo-1611974717461-677ed4757448?q=80&w=500&auto=format&fit=crop",
    websiteUrl: "https://exness.com",
    affiliateLink: "#",
    rating: "4.6/5",
    description: "Instant withdrawals and flexible leverage options. An excellent choice for growing a small account.",
  },
  {
    id: "5",
    name: "Saxo Bank",
    logoUrl: "https://images.unsplash.com/photo-1633412802377-29c762a96870?q=80&w=500&auto=format&fit=crop",
    websiteUrl: "https://saxobank.com",
    affiliateLink: "#",
    rating: "4.5/5",
    description: "Elite institutional-grade tools for the most sophisticated traders in the ForexMax community.",
  },
  {
    id: "6",
    ...
    affiliateLink: "#",
    rating: "4.4/5",
    description: "Comprehensive education and reliable execution. Ideal for traders transitioning from beginner to pro.",
  },
];
          ...
          {DUMMY_BROKERS.map((broker) => (
            <div key={broker.id} className="group block h-full">
              <div className="bg-white/60 dark:bg-zinc-900/60 backdrop-blur-2xl rounded-[2rem] shadow-xl hover:shadow-2xl hover:shadow-emerald-500/20 transition-all duration-500 border border-white/50 dark:border-zinc-700/50 overflow-hidden hover:-translate-y-2 hover:border-emerald-500/50 h-full flex flex-col">
                ...
                {/* Logo Area */}
                <div className="relative h-48 w-full bg-gradient-to-br from-white/40 to-white/10 dark:from-zinc-800/40 dark:to-zinc-900/40 overflow-hidden border-b border-zinc-200/50 dark:border-zinc-800/50">
                  {broker.logoUrl ? (
                    <Image 
                      src={broker.logoUrl} 
                      alt={broker.name} 
                  ...
                  <div className="absolute top-5 left-5">
                    <span className="px-4 py-2 bg-white/90 dark:bg-zinc-900/90 backdrop-blur-md text-emerald-600 dark:text-emerald-400 text-xs font-black rounded-xl shadow-lg border border-emerald-500/20 uppercase tracking-widest flex items-center gap-1">
                      <Star className="h-3 w-3 fill-current" /> {broker.rating}
                    </span>
                  </div>
                </div>
